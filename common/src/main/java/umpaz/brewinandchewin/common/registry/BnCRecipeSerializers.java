...
public class BnCRecipeSerializers {
    ...
    public static final RecipeSerializer<?> DISTILLING = new DistillingRecipe.Serializer();
    ...
    public static void registerAll() {
        ...
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, BrewinAndChewin.asResource("distilling"), DISTILLING);
